                ...
                <div class="well well-small">
                    ...
                    <div class="row-fluid">
                        ...
                        <form action="ejecutaractualizar2.php" method="post">
                            ...
                            Producto<br> <input type="text" name="user" value="<?php echo $producto?>"><br>
                            Estado <br> <input type="text" name="pass" value="<?php echo $estado_producto?>"><br>
                            Destino<br> <input type="text" name="email" value="<?php echo $destino_producto?>"><br>
